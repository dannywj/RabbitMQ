...
class CI_Consumer{
    ...
    */
    public function __construct($arrConfig=array())
    {
        ...
        } elseif(isset($arrConfig['seq'])) {
            $this->config = $amqp[$arrConfig['connect_key']][$arrConfig['seq']];
        } else {
    ...
    * @return void  
    */
    public function init($exchange_name, $routing_key_name, $queue_name, $exchange_type = 'direct', $durable = true, $mirror = false, $prefetchcount = 50)
    {
        if(empty($exchange_name) || empty($routing_key_name) || empty($queue_name) || empty($this->exchange_types[$exchange_type])){
            return false;
        }
    ...
    * @return bool
    */
    public function activateConnect(){
